...
class BasketViewTableViewCell: UITableViewCell{
    ...
    func configureWithProduct(product: Product){
        ...
        self.quantity.text = "\(Constant.quantity) \(product.quantity ?? 1)"
        self.downloadImage()
    }
}

// MARK: - ImageDownloadRequired
extension BasketViewTableViewCell: ImageDownloadRequired {
...
extension BasketViewTableViewCell: CancelAPIRequestRequired {
